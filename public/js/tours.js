...
const PLACEHOLDER_SVG = 'data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 400 240%22%3E%3Crect fill=%22%23e0e0e0%22 width=%22400%22 height=%22240%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 dominant-baseline=%22middle%22 text-anchor=%22middle%22 font-family=%22Arial%22 font-size=%2220%22 fill=%22%23999%22%3ENo Image%3C/text%3E%3C/svg%3E';
    ...
    return `
        <div class="tour-card" onclick="navigateToTour(${item.id})">
            <div class="tour-card-image">
                <img src="${item.image || PLACEHOLDER_SVG}" 
                     alt="${item.name}" onerror="this.src='${PLACEHOLDER_SVG}'" loading="lazy">
...
function searchAndFilterTours() {
    ...
    filteredTours = allTours.filter(item => {
        ...
        const matchesCategory = !filterCategory || 
                               (item.durationCategory === filterCategory);
